...
import {BiKey, BiCoinStack} from "react-icons/bi";
...
const ProfileHeader = (props) => {
    ...
    const firstName = useSelector(state => state.auth.data?.personalInformation?.firstName)
            ...
            <div className='profile-header'>
                ...
                <div className='profile-links'>
                    <Link to='/profile/wallet'>
                        <div id='wallet' className='profile-header-item'><BsBullseye style={{marginRight: '5px'}}/>Overview
                        </div>
                    </Link>
