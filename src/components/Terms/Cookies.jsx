            ...
            <div className="textinfo">
                ...
                <ul>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Cookies Policy) refers to Algorax.
                    </li>
                    <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or
                        any other device by a website, containing details of your browsing history on that website among
                        its many uses.
                    </li>
                    <li><strong>Website</strong> refers to Algorax, accessible from algorax.net</li>
                    <li><strong>You</strong> means the individual accessing or using the Website, or a company, or any
                ...
                <br/>
                    ...
                    <p>If You prefer to avoid the use of Cookies on the Website, first You must disable the use of
                        ...
                        website. You may use this option for preventing the use of Cookies at any time.</p>
                    ...
                    <ul>
                        <li>
                            <p>For the Chrome web browser, please visit this page from Google: <a
                                ...
                                target="_blank">https://support.google.com/43221</a></p>
                        </li>
                        <li>
                            <p>For the Internet Explorer web browser, please visit this page from Microsoft: <a
                                href="https://support.microsoft.com/kb/278835" rel="external nofollow noopener"
                                target="_blank">http://support.microsoft.com/kb</a></p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>For the Safari web browser, please visit this page from Apple: <a
                                ...
                                rel="external nofollow noopener"
                                target="_blank">https://support.apple.com/guide</a>
                            </p>
                        </li>
                    </ul>
