    ...
    return (
        <div className='term'>
            ...
            <div className="textinfo">
                <p>At Algorax, accessible from algorax.net, one of our main priorities is the privacy of our
                    visitors. This Privacy Policy document contains types of information that is collected and recorded
                    by Algorax and how we use it.<br/>
                    <br/>
                    ...
                    Algorax. This policy is not applicable to any information collected offline or via
                ...
                <ul>
                    ...
                    <li>-&nbsp;&nbsp;&nbsp; Communicate with you, either directly or through one of our partners,
                        including for customer service, to provide you with updates and other information relating to
                ...
                <p><br/>
                    ...
                    <br/>
                    Algorax follows a standard procedure of using log files. These files log visitors when they
                    ...
                    movement on the website, and gathering demographic information.<br/>
                    Cookies and Web Beacons<br/>
                    <br/>
                    Like any other website, Algorax uses 'cookies'. These cookies are used to store
                    ...
                    partners of Algorax.<br/>
                    <br/>
                    Third-party ad servers or ad networks uses technologies like cookies,
                    JavaScript, or Web Beacons that are used in their respective advertisements and
                    links that appear on Algorax, which are sent directly to users' browser. They
                    ...
                    <br/>
                    Note that Algorax has no access to or control over these cookies that are
                    used by third-party advertisers.<br/>
                    Third Party Privacy Policies<br/>
                    <br/>
                    Algorax's Privacy Policy does not apply to other advertisers or
                    ...
                    <br/>
                    <strong>Under the CCPA, among other rights, California consumers
                        have the right to:</strong><br/>
                    <br/>
                    ...
                    the consumer that a business has collected.<br/>
                    <br/>
                    ...
                    any of these rights, please contact us.<br/>
                    ...
                    correct any information you believe
                    is inaccurate. You also have the
                    right to request that we complete
                    the information you believe is
                    incomplete.<br/>
                    <br/>
                    The right to erasure – You have
